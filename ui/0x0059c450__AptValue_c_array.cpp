...
void AptValue::assertIsArray(void)
{
  ...
  cVar3 = FUN_0059c500(); // likely AptValue::isArray()
  if (cVar3 != '\0') {
    return;
  }
  local_14 = "isArray()";
  local_10 = "c:\\packages001_pc\\apt\\0.19.optimized\\source\\apt\\_AptValue.h";
  local_c = 0xfd; // line number 253
  local_8 = 2; // assertion type
  local_4 = &DAT_01128f0e; // global assertion flag
  if (DAT_01128f0e != '\0') {
    piVar1 = *(int **)(**(int **)(unaff_FS_OFFSET + 0x2c) + 0x30); // get thread-local assertion handler
    uVar4 = 1;
    if (((piVar1 == (int *)0x0) ||
    ...
    if (((piVar1 != (int *)0x0) || (local_8 != 4)) &&
      ...
      pcVar2 = (code *)swi(3); // software interrupt for debug break
      (*pcVar2)();
      return;
    }
    return;
