...
undefined4 AptValue::isValidOrAssert(void)

{
  ...
  if (unaff_EDI != (uint *)0x0) goto LAB_005a7cfe;
  local_14 = &DAT_00e3b9b8;
  local_10 = "c:\\packages001_pc\\apt\\0.19.optimized\\source\\apt\\_AptValue.h";
  local_c = 0x186;
  local_8 = 2;
  local_4 = &DAT_01128fb5;
  if (DAT_01128fb5 == '\0') goto LAB_005a7cfe;
...
LAB_005a7cdb:
    ...
    if (local_4 != (undefined1 *)0x0) goto LAB_005a7cdb;
  }
...
LAB_005a7cfe:
  if (((*unaff_EDI & 0x7fff) == 5) && ((~(byte)(*unaff_EDI >> 0xf) & 1) == 0)) {
    return 1;
  }
  return 0;
}