...
undefined4 * __thiscall UnknownClass::constructor(undefined4 *this, int param_2)
{
  ...
  FUN_0064d390(0,1);  // likely a debug/logging function
  ...
  *this = &PTR_LAB_00d79dc8;  // vtable pointer updated (likely derived class)
  this[10] = &PTR_LAB_00d79bd8;  // +0x28: pointer to another vtable or data
  this[0xc] = &LAB_008a8960;  // +0x30: function pointer or data pointer
